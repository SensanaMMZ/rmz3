...
## Byte-identical (1 clusters) — identical including call offsets and pool words
...
## Identical modulo calls and pool literals (4 clusters) — bl bits and address-like pool words masked
