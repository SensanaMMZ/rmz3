...
## Identical modulo call targets (5 clusters) — bl offset bits masked; everything else identical
...
## Identical modulo calls and pool literals (7 clusters) — bl bits and address-like pool words masked
