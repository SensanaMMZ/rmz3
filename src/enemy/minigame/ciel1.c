...
s32 FUN_0809c110(struct Enemy* p);

// 0x0809bec8
// Scratch-parity basin: structure matches (walk-form saves, both hit arms,
// division phi copy, joypad guards) but half a dozen independent register
// pairs sit swapped (sv/value, bp/e04, t/col, work[1] scratch) and each
// lever that flips one rotates another.
