...
s32 tretista_0804dd00(struct Boss* p);

void tretista_0804dc90(struct Boss* p) {
  switch ((p->s).mode[2]) {
    case 0:
      (p->s).flags &= ~DISPLAY;
      SetMotion(&p->s, MOTION(0xAB, 0x09));
      (p->s).mode[2]++;
      /* fallthrough */
    case 1:
      UpdateMotionGraphic(&p->s);
...
INCASM("asm/boss/tretista_p2b.inc");
...
void tretista_0804e020(struct Boss* p) {
  switch ((p->s).mode[2]) {
    case 0:
      (p->s).flags |= DISPLAY;
      SetMotion(&p->s, 0xAB09);
      (p->s).work[2] = 0;
      (p->s).mode[2]++;
      // fallthrough
    case 1:
      if (((p->s).scriptEntity->flags & 1) && (p->s).work[2] == 0) {
        (p->s).work[2] = 1;
        PlaySound(0xD4);
      }
...
void tretistaHellBouncers(struct Boss* p) {
  ...
  switch ((p->s).mode[2]) {
    ...
    case 3:
      ...
      goto bump;
    case 4: {
      register struct Enemy** b1 asm("r4");
      c.y = (p->s).coord.y + -0x2B00;
      c.x = (p->s).coord.x + -0x1100;
      {
        register struct Enemy* r asm("r0");
        r = createHellBouncer(&p->s, &c, 1, 1);
        b1 = (struct Enemy**)((u8*)p + 0xc8);
        *b1 = r;
      }
      {
      ...
      {
        register struct Enemy** b2 asm("r2");
        register struct Enemy* r asm("r0");
        r = createHellBouncer(&p->s, &c, 1, 0);
        b2 = (struct Enemy**)((u8*)p + 0xcc);
        *b2 = r;
        *(struct Enemy**)((u8*)r + 0x2c) = *b1;
        {
          register struct Enemy* q asm("r1");
          q = *b1;
          *(struct Enemy**)((u8*)q + 0x2c) = *b2;
        }
      }
      PlaySound(0xd6);
      SetMotion(&p->s, 0xAB1A);
      UpdateMotionGraphic(&p->s);
      (p->s).work[2] = 0x1e;
      (p->s).mode[2]++;
      FALLTHROUGH;
    ...
    case 7:
      UpdateMotionGraphic(&p->s);
      if (*((u8*)(*(u8**)((u8*)p + 0xc8)) + 0xb9) != 1) {
        break;
      }
      if (*((u8*)(*(u8**)((u8*)p + 0xcc)) + 0xb9) != 1) {
        break;
      }
      goto bump;
    case 8:
      SetMotion(&p->s, 0xAB04);
      SetDDP(&p->body, &sCollisions[7]);
      (p->s).mode[2]++;
      FALLTHROUGH;
    case 9:
      ...
      }
      {
        ...
        q = (u8*)(*(u8**)((u8*)p + 0xc8)) + 0xb9;
        two = 2;
        *q = two;
        q = (u8*)(*(u8**)((u8*)p + 0xcc)) + 0xb9;
        *q = two;
      }
      goto bump;
    case 10:
      UpdateMotionGraphic(&p->s);
      if (*((u8*)(*(u8**)((u8*)p + 0xc8)) + 0xb9) != 3) {
        break;
      }
      if (*((u8*)(*(u8**)((u8*)p + 0xcc)) + 0xb9) != 3) {
        break;
      }
      SetMotion(&p->s, 0xAB08);
      UpdateMotionGraphic(&p->s);
      goto bump;
    case 11:
      PlaySound(0xd7);
