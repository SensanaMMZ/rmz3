      ...
      }
      {
        ...
        *((u8*)p + 0xbc) = v;
        ...
        if ((v << 24) == 0) {
          ...
          SetMotion(&p->s, 0xA708);
        } else {
          SetDDP(&p->body, &sCollisions[9]);
          SetMotion(&p->s, 0xA709);
        }
      }
      (p->s).mode[2]++;
      FALLTHROUGH;
...
void deathtanzEX1(struct Boss* p) {
  switch ((p->s).mode[2]) {
    case 0: {
      ...
      base = ((p->props).deathtanz).unk_b4.x;
    ...
    case 2:
      ...
      SetMotion(&p->s, MOTION(0xA7, 0x27));
      (p->s).mode[2]++;
      FALLTHROUGH;
    case 3:
      UpdateMotionGraphic(&p->s);
    ...
    case 4:
      ...
      FALLTHROUGH;
    case 5:
      deathtanz_080a09f4(&p->s, (p->s).coord.x, (p->s).coord.y - 0x4900, (p->s).work[2],
                         ((p->s).flags >> 4) & 1);
      SetMotion(&p->s, MOTION(0xA7, 0x29));
      (p->s).mode[2]++;
      FALLTHROUGH;
    case 6:
      UpdateMotionGraphic(&p->s);
    ...
    setmode5:
      ...
      break;
    case 7:
      SetMotion(&p->s, MOTION(0xA7, 0x2A));
      (p->s).work[2] = 0x5a;
      (p->s).mode[2]++;
      FALLTHROUGH;
    case 8:
...
void deathtanz_0804adb0(struct Boss* p) {
  switch ((p->s).mode[2]) {
    case 0: {
      ...
      SetMotion(&p->s, MOTION(0xA7, 0x38));
      {
    ...
    case 2:
      (p->s).unk_2c = CreateBossExplosion(&p->s, (struct Coord*)&sExplosionCoords[1]);
      (p->s).mode[2]++;
      FALLTHROUGH;
    case 3:
      if (((struct Entity*)(p->s).unk_2c)->mode[0] <= 1) {
