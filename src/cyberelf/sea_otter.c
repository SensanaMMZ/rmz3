...
// 0x080E4628
void SeaOtterElf_Init(struct Elf* p) {
  struct Zero* z = ((struct CyberElfSeaOtter*)p)->player;
  ...
  }
  {
    ...
    *oa = m11 & ov;
    (p->s).flags &= 0xEF;
    {
      ...
      *(s32*)&((struct CyberElfSeaOtter*)p)->unk_b8[0] = nx;
      *(s32*)&((struct CyberElfSeaOtter*)p)->unk_b8[4] = (p->s).coord.y;
    }
    asm("" : "+r"(oa));
    oa += 0x78;
    asm("" : "+r"(oa));
    {
      ...
      ((struct CyberElfSeaOtter*)p)->unk_b8[8] = zz;
    }
  }
  ((struct CyberElfSeaOtter*)p)->unk_b8[9] = 0x20;
  {
