...
// 0x080dc900 -- parked (ghost-save): byte-exact except the push/pop
// list. Retail allocates the LCG C-constant / 0x1000 offset into r7
// NATURALLY (saved in the prologue); agbcc reaches r7 only via pinned
